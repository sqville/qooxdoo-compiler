 ...
 *
 *
 * @childControl message {qx.ui.basic.Atom} first text and icon part of the widget
 ...
 */
qx.Class.define("${namespace}.Upload",
{
  ...
  */
  ...
  construct : function(message, label, icon)
  {
    ...
    this._setLayout(new qx.ui.layout.VBox(20).set({alignX: "center", alignY: "middle"}));
  ...
  members :
  {
    ...
    _createChildControlImpl : function(id, hash)
    {
      ...
      switch(id)
      {
        ...
        case "button":
          control = new qx.ui.form.Button("blank", "${namespace_as_path}/test.png").set({allowGrowX: false});
