  ...
  */
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      var btnbackbutton = new qx.ui.toolbar.Button("Back", "${namespace_as_path}/baseline-chevron_left-24px.svg").set({show: "icon"});
      ...
      if (qx.core.Environment.get("phonegap")) {
        var atmlogocurrentpage = new qx.ui.basic.Atom("${namespace}","${namespace_as_path}/wax_logo-24px.svg").set({font: "hym-app-header", gap: 6, paddingLeft: 35});
      ...
      // GroubBox
      var groupbox1 = new ${namespace}.GroupBox("First GroupBox", "${namespace_as_path}/baseline-directions_subway-24px.svg", true, true, false);
      groupbox1.setLayout(new qx.ui.layout.VBox());
      var piechartimage = new qx.ui.basic.Image("${namespace_as_path}/pie_chart-24px.svg").set({scale: true, width: 272, height: 272});

      var groupbox2 = new ${namespace}.GroupBox("Second GroupBox", "${namespace_as_path}/local_airport-24px.svg", true, true, false);
      groupbox2.setLayout(new qx.ui.layout.VBox());

      var groupbox3 = new ${namespace}.GroupBox("Third GroupBox - with linebreak", "${namespace_as_path}/commute-24px.svg", true, true, false);
      groupbox3.setLayout(new qx.ui.layout.VBox());

      var groupbox4 = new ${namespace}.GroupBox("Forth GroupBox - Flow within a Flow", "${namespace_as_path}/local_dining-24px.svg", true, true, false);
      ...
      groupbox4.add(new qx.ui.basic.Image("${namespace_as_path}/bar_chart-24px.svg").set({scale: true, width: 222, height: 222}));
      groupbox4.add(new qx.ui.basic.Image("${namespace_as_path}/bar_chart-24px.1.svg").set({scale: true, width: 222, height: 222}));
      groupbox4.add(new qx.ui.basic.Image("${namespace_as_path}/bar_chart-24px.2.svg").set({scale: true, width: 222, height: 222}));
      groupbox4.add(new qx.ui.basic.Atom("Year over year growth shows how the market favored the bold","${namespace_as_path}/bolt-24px.svg").set({rich: true, width: 200, height: 142}));

      var barchartimage = new qx.ui.basic.Image("${namespace_as_path}/view_compact-24px.svg").set({scale: true, width: 312, height: 312});
      var bubblechartimage = new qx.ui.basic.Image("${namespace_as_path}/bubble_chart-24px.svg").set({scale: true, width: 312, height: 312});
      ...
      //winDoThis.add(new qx.ui.basic.Image("${namespace_as_path}/Roxarama-Guy.png"));
      ...
      secpagegroupbox2.add(new qx.ui.basic.Atom("Warning message about doing that.","${namespace_as_path}/warning-24px.svg"));

      var winDoThat = this.__createDetailWindow();
      winDoThat.set({caption: "Do That", status: "Modal window without a blocker"});
      winDoThat.add(new qx.ui.basic.Image("${namespace_as_path}/Roxarama-Guy.png"));
      ...
      if (qx.core.Environment.get("device.type") == "desktop"){
        ...
        ctrlUpload.getChildControl("message").set({ icon: "${namespace_as_path}/cloud_upload-24px.svg", iconPosition: "top", gap: 0});
      ...
      var gallerygroupboxcars = new ${namespace}.GroupBox("Cars", "${namespace_as_path}/commute-24px.svg", true, true, false);
      ...
      gallerygroupboxcars.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Yellow_Car2.jpg").set({scale: true, width: 420, height: 280}));
      gallerygroupboxcars.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Flame_Car2.jpg").set({scale: true, width: 420, height: 280}));
      
      var gallerygroupboxtrain = new ${namespace}.GroupBox("Trains", "${namespace_as_path}/baseline-directions_subway-24px.svg", true, true, false);
      ...
      gallerygroupboxtrain.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Deep_Train_Bridge_Sky.JPG").set({scale: true, width: 420, height: 280}));
      gallerygroupboxtrain.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Top_Train_Bridge.JPG").set({scale: true, width: 420, height: 280}));
      gallerygroupboxtrain.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Train_Bridge_Close.JPG").set({scale: true, width: 420, height: 280}));
      gallerygroupboxtrain.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Train_Bridge_Close2.JPG").set({scale: true, width: 420, height: 280}));
      gallerygroupboxtrain.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Deep_Train_Bridge.jpg").set({scale: true, width: 280, height: 420}));

      var gallerygroupboxfood = new ${namespace}.GroupBox("Food", "${namespace_as_path}/local_dining-24px.svg", true, true, false);
      ...
      gallerygroupboxfood.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Vegies2.jpg").set({scale: true, width: 420, height: 280}));
      ...
      gallerygroupboxart.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Crowd_Pressure.png").set({scale: true, width: 420, height: 280}));
      gallerygroupboxart.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Normal_Dude.png").set({scale: true, width: 420, height: 350}));
      gallerygroupboxart.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/RoxArms.jpg").set({scale: true}));
      gallerygroupboxart.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/Santa_Color-Orig.JPG").set({scale: true, width: 420, height: 306}));
      gallerygroupboxart.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/holiday_cheer.JPG").set({scale: true, width: 420, height: 392}));
      gallerygroupboxart.add(new qx.ui.basic.Image("${namespace_as_path}/Roxarama-Guy.png").set({scale: true}));
      ...
      gallerygroupboxvideo.add(new qx.ui.basic.Image("${namespace_as_path}/gallery/movie1.jpg").set({scale: true}));
      ...
      //if (qx.core.Environment.get("phonegap")) {
        ...
        var btnProfile = new qx.ui.form.Button("Profile", "${namespace_as_path}/edit-24px.svg").set({appearance : "hym-page-button"});
        //btnProfile.getLayoutParent().add(new qx.ui.core.Spacer());
        var btnSettings = new qx.ui.form.Button("Settings", "${namespace_as_path}/outline-settings-24px.svg").set({appearance : "hym-page-button"});
        //var btnSupport = new ${namespace}.MenuButton("Support", "${namespace_as_path}/assignment_returned-24px.svg", false);
        var btnLogout = new qx.ui.form.Button("Logout", "${namespace_as_path}/exit_to_app-24px.svg").set({appearance : "hym-page-button"});
      ...
      var atmleftnavheader = new qx.ui.basic.Atom("Hello, Admin", "${namespace_as_path}/round-account_circle-24px.svg").set({appearance: "header-atom", anonymous: true, focusable: false, selectable: false });
      atmleftnavheader.getChildControl("icon").set({ scale : true });
      westbox.add(atmleftnavheader);
      var tbtndashboardpage = new ${namespace}.MenuButton("Dashboards", "${namespace_as_path}/dashboard-24px.svg", true );
      westbox.add(tbtndashboardpage);

      var tbtnSecondPage = new ${namespace}.MenuButton("Actions", "${namespace_as_path}/assignment_returned-24px.svg", true);
      ...
      var tbtnThirdPage = new ${namespace}.MenuButton("List of Items", "${namespace_as_path}/view_list-24px.svg", true);
      westbox.add(tbtnThirdPage);

      var tbtnGalleryPage = new ${namespace}.MenuButton("Gallery", "${namespace_as_path}/camera-24px.svg", true, "14" );
      ...
      var tbtndashboardpagehym = new ${namespace}.MenuButton("Dashboards", "${namespace_as_path}/dashboard-24px.svg", true ).set({appearance: "mainmenubutton-hym", iconPosition: "top"});
      var tbtnoverviewpagehym = new ${namespace}.MenuButton("Actions", "${namespace_as_path}/assignment_returned-24px.svg", true).set({appearance: "mainmenubutton-hym", iconPosition: "top"});
      var tbtnlistofitemspagehym = new ${namespace}.MenuButton("List of Items", "${namespace_as_path}/view_list-24px.svg", true).set({appearance: "mainmenubutton-hym", iconPosition: "top"});
      var tbtngallerypagehym = new ${namespace}.MenuButton("Gallery", "${namespace_as_path}/camera-24px.svg", true).set({appearance: "mainmenubutton-hym", iconPosition: "top"});
      var tbtnmenuhym = new ${namespace}.MenuButton("Menu", "${namespace_as_path}/round-menu-24px.svg", true).set({appearance: "mainmenubutton-hym", iconPosition: "top"});
    ...
    __createrowData : function()
    {
      ...
      rowData.push([ "${namespace_as_path}/round-check_circle_outline-24px.svg", "Completed", "001007222", "This Core", date ]);
      date = new Date(now + Math.random() * dateRange - dateRange / 2);
      rowData.push([ "${namespace_as_path}/round-check_circle_outline-24px.svg", "Completed", "002009333", "That Core", date ]);
      date = new Date(now + Math.random() * dateRange - dateRange / 2);
      rowData.push([ "${namespace_as_path}/round-check_circle_outline-24px.svg", "Completed", "003002777", "DTDT", date ]);
      date = new Date(now + Math.random() * dateRange - dateRange / 2);
      rowData.push([ "${namespace_as_path}/round-check_circle_outline-24px.svg", "Completed", "004074555", "eThis Modernization", date ]);
      date = new Date(now + Math.random() * dateRange - dateRange / 2);
      rowData.push([ "${namespace_as_path}/round-sync-24px.svg", "In Progress", "005111888", "eThat Modernization", date ]);
      date = new Date(now + Math.random() * dateRange - dateRange / 2);
      rowData.push([ "${namespace_as_path}/round-sync-24px.svg", "In Progress", "006003662", "eThis eThat Integration", date ]);
